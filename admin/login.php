...
<body class="text-center">
    <div class="card form-signin opacity-50" style=" border-radius: 20px; width: 18rem;">
        <div class="card-body">
            <img class="mb-4 card-title" src="assets/img/log1.png" alt="" width="100" height="75">
            <form method="POST" enctype="multipart/form-data">
                <h5 class="card-subtitle mb-2">Hallo Admin</h5>
                ...
                <button class="w-100 btn btn-lg btn-dark" name="submit">
                    <h6>Login</h6>
                </button>
                <p>
